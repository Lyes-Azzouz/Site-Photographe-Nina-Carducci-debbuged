(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      const activeImage = $("img.gallery-item").filter((index, el) => $(el).attr("src") === $(".lightboxImage").attr("src"));
      ...
      const index = imagesCollection.findIndex((el) => $(activeImage).attr("src") === $(el).attr("src"));
